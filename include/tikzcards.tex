...
\def\shapeLeftStripLong{(\strippadding,-0.2) rectangle (\strippadding+\stripwidth,\cardheight)}
...
\newcommand{\cardtypeUsecase}{\cardtype{usecasebg}{Usecase}}
\newcommand{\cardtypeTechnology}{\cardtype{technologybg}}
\newcommand{\cardtypeTarget}{\cardtype{targetbg}{Target Audience}}
\newcommand{\cardtypeInvestor}{\cardtype{investorbg}{Investors}}
\newcommand{\cardtypeAction}{\cardtype{actionbg}{Action}}
...
\newcommand{\cardcontent}[2]{
    ...
    \end{scope}
    \node[below right, text width=(\cardwidth-2*\strippadding-\stripwidth-2*\textpadding-0.3)*1cm] at (2*\strippadding+\stripwidth+\textpadding,0.8*\cardheight-\textpadding) {
        {\normalsize #1}
    };
    \node[below right, text width=(\cardwidth-2*\strippadding-\stripwidth-2*\textpadding-0.3)*1cm] at (2*\strippadding+\stripwidth+\textpadding,4) {
...
\newcommand{\cardprice}[1]{
    ...
    \end{scope}
    \node at (\cardwidth-0.5*\stripwidth-\strippadding,\titley-0.1) {\color{}#1};
}
